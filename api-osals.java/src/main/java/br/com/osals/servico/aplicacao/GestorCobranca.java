 ...
 * (e por backfill nos existentes); aqui buscamos e atualizamos. Cobranca faz parte
 * do faturamento (feito apos concluir o Servico), entao alterar NAO depende do
 * Servico estar aberto — basta a permissao FATURAMENTO_EDITAR (exigida no endpoint).
 */
@Service
